...
namespace EMACClass
{
    public class TestProblemesPhysiques : TestProblemes
    {
        ...
        public TestProblemesPhysiques(bool difficulteTest) : base(difficulteTest)
        {
            nom = "Problèmes Physiques";
            consigne = "";
    ...
    protected override void GenererListeQuestions()
    {
        ...
        using (connexionBDD)
        {
            ...
            using (OleDbCommand requete2 = new OleDbCommand())
            {
                ...
                if (difficulte == true)
                {
                    requete2.CommandText = "SELECT * FROM Questions q LEFT JOIN Images i ON i.Question=q.Id WHERE Test=5 and type='Difficile'";
                ...
                {
                    requete2.CommandText = "SELECT * FROM Questions q LEFT JOIN Images i ON i.Question=q.Id WHERE Test=5 and type='Facile'";
                    OleDbDataReader reader2 = requete2.ExecuteReader();
